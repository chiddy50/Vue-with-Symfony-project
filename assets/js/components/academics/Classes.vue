                    ...
                    <form class="new-added-form" @submit.prevent="createClass($event)">
                        <div class="row">
                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                ...
                                <input type="text" v-model="class_name" name="class_name" placeholder="" class="form-control rounded-0">
                            </div>
                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                <label>Class Code</label>
                                <input type="text" v-model="class_code" name="class_code" placeholder="" class="form-control rounded-0">
                            </div>
                            
                            <div class="col-12 form-group mg-t-8">
                                <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" :disabled="classLoad">{{btnText}}</button>
                            ...
                            <tbody v-if="!classLoading">
                                <tr v-for="(single_class, index) in classes" :key="single_class.id">                                    
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-lg shadow-dark-peel bg-danger rounded-bottom text-light" @click="deleteClass(single_class.id, index, $event)">
                                            <i class="fas fa-trash text-light"></i> 
                                        </button>
                                        <i class="fas fa-spinner fa-spin text-danger spinner-sm"></i>
                                    </td>
                                    <td>
                                        <button class="btn btn-lg shadow-dark-peel bg-success rounded-bottom text-light" @click="editClass(single_class)">
