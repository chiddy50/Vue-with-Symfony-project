       ...
       <div class="col-sm-12">              
            <div class="card height-auto">
                <div class="card-body">
                    ...
                    <i v-if="classLoading || sectionLoading || $store.state.searchLoading" class="fas fa-spinner fa-spin text-primary spinner"></i>
                    
                    <form class="new-added-form" @submit.prevent="searchStudent($event)">
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-12 form-group">
                                <label>Select Class</label>
                                <select v-if="!classLoading" name="class_id" class="form-control select2" v-model="form.class_id">
                            ...
                            <div class="col-xl-4 col-lg-4 col-12 form-group">
                                ...
                                <select v-if="!sectionLoading" name="section_id" class="form-control select2" v-model="form.section_id">
                            ...
                            <div class="col-xl-4 col-lg-4 col-12 form-group">
                                ...
                                <select v-if="!groupLoading" name="student_group" class="form-control select2" v-model="form.student_group">
        ...
        <SubjectAttendanceTable v-if="$store.state.filteredStudents.length && subjects.length" :subjects="subjects"/>
...
export default {
    ...
    computed:{
        ...mapState(['classes', 'sections', 'classLoading', 'sectionLoading', 'student_group', 'groupLoading']),
    },
    methods:{
